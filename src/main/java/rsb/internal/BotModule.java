...
public class BotModule extends RuneLiteModule {
    ...
    public BotModule(OkHttpClient okHttpClient, Supplier<Applet> clientLoader, Supplier<RuntimeConfig> configLoader, boolean developerMode, boolean safeMode, File sessionfile, File config) {
        super(okHttpClient, clientLoader, configLoader, developerMode, safeMode, sessionfile, config);
